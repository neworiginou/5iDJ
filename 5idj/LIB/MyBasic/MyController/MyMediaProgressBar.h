...
//轨迹背景颜色，默认为黑灰色
@property(nonatomic,strong) UIColor * trackBGColor UI_APPEARANCE_SELECTOR;

//播放进度轨迹颜色，默认为白色
@property(nonatomic,strong) UIColor * glowTrackColor UI_APPEARANCE_SELECTOR;

//加载进度的轨迹，默认为浅灰色
@property(nonatomic,strong) UIColor * loadedTrackColor UI_APPEARANCE_SELECTOR;
